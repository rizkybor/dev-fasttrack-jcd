...
const DEFAULT_PATH = "/notaris-virtual-dan-akta";

const serviceList = computed(() => {
    const list = tm("services.notarisVirtualDanAkta.list");
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.notarisVirtualDanAkta.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-notaris-virtual-dan-akta.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.notarisVirtualDanAkta.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.notarisVirtualDanAkta.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.notarisVirtualDanAkta.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.notarisVirtualDanAkta.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.notarisVirtualDanAkta.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.notarisVirtualDanAkta.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/notaris-virtual-dan-akta/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.notarisVirtualDanAkta.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.notarisVirtualDanAkta.items.cta") }}
                                <svg
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.notarisVirtualDanAkta.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.notarisVirtualDanAkta.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.notarisVirtualDanAkta.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.notarisVirtualDanAkta.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
