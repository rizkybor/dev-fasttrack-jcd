...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.badanUsahaDetail.wa_message")} ${productName}.`;
                ...
                <nav aria-label="Breadcrumb">
                    <div class="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2">
                        ...
                        <a href="/layanan" class="text-sm font-medium text-[#9e1f16] hover:underline">
                            {{ t('services.badanUsahaDetail.breadcrumb.layanan') }}
                        </a>
                        <svg class="h-3 w-3 text-[#9e1f16]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                        </svg>
                        <a href="/badan-usaha" class="text-sm font-medium text-[#9e1f16] hover:underline">
                            {{ t('services.badanUsahaDetail.breadcrumb.current') }}
                        </a>
                        <svg class="h-3 w-3 text-[#9e1f16]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid gap-8 lg:grid-cols-[1fr_280px] xl:grid-cols-[1fr_300px]">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                    {{ t('services.badanUsahaDetail.sections.penjelasan') }}
                                </h2>
                            </div>
                            <div class="space-y-4">
                                <p v-for="(paragraph, index) in localizedProduct.content" :key="`content-${index}`"
                        ...
                        <div v-if="localizedProduct.term_condition.length"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            <div class="flex items-center gap-3 mb-5">
                                <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                    {{ t('services.badanUsahaDetail.sections.syarat') }}
                                </h2>
                            </div>
                            <ol class="space-y-4">
                                <li v-for="(req, index) in localizedProduct.term_condition" :key="`req-${index}`"
                        ...
                        <div v-if="localizedProduct.benefits.length"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                    {{ t('services.badanUsahaDetail.sections.keuntungan') }}
                                </h2>
                            </div>
                            <div
                                :class="localizedProduct.benefits.length < 4 ? 'flex flex-col gap-4' : 'grid grid-cols-1 sm:grid-cols-2 gap-4'">
                                <div v-for="(benefit, index) in localizedProduct.benefits" :key="`benefit-${index}`"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p v-if="benefit.description" class="text-[13px] leading-[1.6] text-[#3D3D3A]"
                                            :class="localizedProduct.benefits.length >= 4 ? 'text-justify' : ''">
                                            {{ benefit.description }}
                                        </p>
                                        <ul v-if="benefit.notes && localizedProduct.benefits.length < 4"
                                        ...
                                        <p v-if="benefit.footer && localizedProduct.benefits.length < 4"
                        ...
                        <div class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            <div class="flex items-center gap-3 mb-8">
                                <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                    {{ t('services.badanUsahaDetail.sections.alur') }}
                                </h2>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-6 sm:gap-0">
                                <div v-for="(step, index) in localizedProduct.process" :key="`step-${index}`"
                                    class="relative flex flex-col items-center text-center flex-1">
                                    <div v-if="index < localizedProduct.process.length - 1"
                                    ...
                                    <div
                                        ...
                                        <img src="/icons/ft-docs-white.svg" class="mt-0.5 h-5 w-5 flex-shrink-0"
                                            alt="docs-white" />
                                    </div>
                                    <p class="text-[13px] font-semibold text-black leading-snug mb-1 px-2">{{ step.title
                                        }}</p>
                                    <p class="text-[12px] leading-[1.5] text-black px-2 max-w-[140px]">{{
                                        step.description }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-2xl border border-[#E8E8E6] bg-white overflow-hidden">
                            <button @click="docsOpen = !docsOpen"
                                class="w-full flex items-center justify-between p-6 sm:p-8 text-left">
                                <div class="flex items-center gap-3">
                                    <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                    <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                        {{ t('services.badanUsahaDetail.sections.dokumen') }}
                                    </h2>
                                </div>
                                <svg class="h-5 w-5 text-[#686964] flex-shrink-0 transition-transform duration-200"
                                    :class="docsOpen ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <div v-show="docsOpen" class="px-6 sm:px-8 pb-6 sm:pb-8 border-t border-[#E8E8E6]">
                                <ol class="mt-5 space-y-4">
                                    <li v-for="(req, index) in localizedProduct.requirements" :key="`doc-${index}`"
                                        class="flex gap-4">
                                        <span
                                        ...
                                        <div class="pt-0.5 flex-1">
                                            <p class="text-[14px] font-semibold text-black leading-snug mb-1">{{
                                                req.title }}</p>
                                            <p v-if="req.description" class="text-[13px] leading-[1.6] text-[#3D3D3A]"
                                                v-html="parseBold(req.description)"></p>
                                            <ul v-if="req.notes && typeof req.notes[0] === 'string'"
                                                class="mt-1 space-y-0.5 list-disc list-inside">
                                                <li v-for="(note, nIndex) in req.notes" :key="`note-${nIndex}`"
                                                    class="text-[13px] leading-[1.6] text-[#3D3D3A]">{{ note }}</li>
                                            </ul>
                                            <ul v-if="req.notes && typeof req.notes[0] === 'object'"
                                                class="mt-1.5 space-y-2 list-disc list-inside">
                                                <li v-for="(note, nIndex) in req.notes" :key="`note-obj-${nIndex}`"
                                                    class="text-[13px] leading-[1.6] text-[#3D3D3A]">
                                            ...
                                            <div v-if="req.sections" class="mt-1 space-y-3">
                                                <div v-for="(section, sIndex) in req.sections"
                                                    :key="`section-${sIndex}`">
                                                    <p class="text-[13px] font-semibold text-[#1A1B18] mb-1">{{
                                                        section.label }}</p>
                                            ...
                                            <div v-if="req.groups && !req.sections" class="mt-1 space-y-2">
                                                <div v-for="(group, gIndex) in req.groups" :key="`group-${gIndex}`">
                                                    <p class="text-[13px] leading-[1.6] text-[#3D3D3A]">{{ group.label
                                                        }}</p>
                                                    <p v-if="group.description"
                                                        class="text-[13px] leading-[1.6] text-[#3D3D3A]">{{
                                                        group.description }}</p>
                                                    <ul v-if="group.notes"
                                                        ...
                                                        <li v-for="(note, nIndex) in group.notes"
                                                            :key="`gnote-${nIndex}`"
                                                            class="text-[13px] leading-[1.6] text-[#3D3D3A]">{{ note }}
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <!-- 6. Paket & Harga -->
                        <div v-if="currentPlans.length" class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                    {{ t('services.badanUsahaDetail.sections.paket') }}
                                </h2>
                            </div>

                            <!-- Layout <= 3 paket -->
                            <div v-if="currentPlans.length <= 3" class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div v-for="(plan, pi) in currentPlans" :key="`plan-${pi}`"
                                    class="relative flex flex-col rounded-xl border"
                                    :class="plan.popular ? 'border-primary shadow-md shadow-primary/10' : 'border-[#E8E8E6]'">
                                    <template v-if="plan.popular">
                                        <div class="absolute -top-3.5 left-1/2 -translate-x-1/2">
                                            <span
                                                ...
                                                {{ t('services.badanUsahaDetail.plans.paling_populer') }}
                                            </span>
                                        </div>
                                    </template>
                                    <div class="p-4 flex flex-col gap-3 flex-1">
                                        <div class="text-[12px] font-bold uppercase tracking-wide text-[#1A1B18]">{{
                                            plan.name }}</div>
                                        <div>
                                            <div class="text-[11px] text-[#686964]">{{
                                                t('services.badanUsahaDetail.plans.mulai_dari') }}</div>
                                            <div class="text-[20px] font-bold leading-tight text-primary">{{ plan.price
                                                }}</div>
                                        </div>
                                        <div class="flex items-start gap-1.5 text-[11px] text-[#3D3D3A]">
                                            <svg class="h-3.5 w-3.5 text-[#25D366] flex-shrink-0 mt-0.5" fill="none"
                                        ...
                                        <div>
                                            <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                t('services.badanUsahaDetail.plans.dokumen_legalitas') }}</div>
                                            <ul class="space-y-1.5">
                                                <li v-for="(doc, di) in plan.dokumen" :key="`doc-${di}`"
                                                    class="flex items-start gap-1.5">
                                                    <img v-if="doc.included" src="/icons/ft-done.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="done" />
                                                    <img v-else src="/icons/ft-wrong.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="wrong" />
                                                    <span
                                                        class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                        :class="expandedDocs[`${pi}-${di}`] ? '' : 'truncate'"
                                                        @click="toggleDoc(`${pi}-${di}`)">{{ doc.label }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                            <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                t('services.badanUsahaDetail.plans.termasuk')
                                                }}</div>
                                            <ul class="space-y-1.5">
                                                <li v-for="(item, ti) in plan.termasuk" :key="`termasuk-${ti}`"
                                                    class="flex items-start gap-1.5">
                                                    <img v-if="item.included" src="/icons/ft-done.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="done" />
                                                    <img v-else src="/icons/ft-wrong.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="wrong" />
                                                    <span
                                                        class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                        :class="expandedDocs[`termasuk-${pi}-${ti}`] ? '' : 'truncate'"
                                                        @click="toggleDoc(`termasuk-${pi}-${ti}`)">{{ item.label
                                                        }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div>
                                            <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                t('services.badanUsahaDetail.plans.bonus') }}
                                            </div>
                                            <ul class="space-y-1.5">
                                                <li v-for="(bon, bi) in plan.bonus" :key="`bonus-${bi}`"
                                                    class="flex items-start gap-1.5">
                                                    <img v-if="bon.included" src="/icons/ft-done.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="done" />
                                                    <img v-else src="/icons/ft-wrong.svg"
                                                        class="mt-0.5 h-3 w-3 flex-shrink-0" alt="wrong" />
                                                    <span
                                                        class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                        :class="expandedDocs[`bonus-${pi}-${bi}`] ? '' : 'truncate'"
                                                        @click="toggleDoc(`bonus-${pi}-${bi}`)">{{ bon.label }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="p-4 pt-0">
                                        <a :href="buildWhatsappLink(plan.name)" target="_blank"
                                            ...
                                            :class="plan.popular ? 'bg-primary text-white hover:bg-primary/90' : 'border border-primary text-primary hover:bg-primary hover:text-white'">
                                            {{ t('services.badanUsahaDetail.plans.pesan') }}
                            ...
                            <template v-else-if="currentPlans.length <= 4">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                                    <div v-for="(plan, pi) in currentPlans.slice(0, 3)" :key="`plan-${pi}`"
                                        class="relative flex flex-col rounded-xl border"
                                        :class="plan.popular ? 'border-primary shadow-md shadow-primary/10' : 'border-[#E8E8E6]'">
                                        <template v-if="plan.popular">
                                            <div class="absolute -top-3.5 left-1/2 -translate-x-1/2">
                                        ...
                                        <div class="p-4 flex flex-col gap-3 flex-1">
                                            ...
                                            <div>
                                                <div class="text-[11px] text-[#686964]">{{
                                                    t('services.badanUsahaDetail.plans.mulai_dari') }}</div>
                                                <div class="text-[20px] font-bold leading-tight text-primary">{{
                                                    plan.price }}</div>
                                            </div>
                                            <div class="flex items-start gap-1.5 text-[11px] text-[#3D3D3A]">
                                                <svg class="h-3.5 w-3.5 text-[#25D366] flex-shrink-0 mt-0.5" fill="none"
                                            ...
                                            <div>
                                                <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                    t('services.badanUsahaDetail.plans.dokumen_legalitas')
                                                    }}</div>
                                                <ul class="space-y-1.5">
                                                    <li v-for="(doc, di) in plan.dokumen" :key="`doc-${di}`"
                                                        class="flex items-start gap-1.5">
                                            ...
                                            <div>
                                                <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                    t('services.badanUsahaDetail.plans.termasuk') }}</div>
                                                <ul class="space-y-1.5">
                                                    <li v-for="(item, ti) in plan.termasuk" :key="`termasuk-${ti}`"
                                                        class="flex items-start gap-1.5">
                                                        <img v-if="item.included" src="/icons/ft-done.svg"
                                            ...
                                            <div>
                                                <div class="text-[11px] font-semibold text-[#1A1B18] mb-2">{{
                                                    t('services.badanUsahaDetail.plans.bonus') }}</div>
                                                <ul class="space-y-1.5">
                                                    <li v-for="(bon, bi) in plan.bonus" :key="`bonus-${bi}`"
                                                        class="flex items-start gap-1.5">
                                                        <img v-if="bon.included" src="/icons/ft-done.svg"
                                                        ...
                                                        <span
                                                            class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                            :class="expandedDocs[`bonus-${pi}-${bi}`] ? '' : 'truncate'"
                                                            @click="toggleDoc(`bonus-${pi}-${bi}`)">{{ bon.label
                                                            }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div v-for="(plan, pi) in currentPlans.slice(3)" :key="`plan-extra-${pi}`"
                                        class="relative flex flex-col rounded-xl border"
                                        :class="plan.popular ? 'border-primary shadow-md shadow-primary/10' : 'border-[#E8E8E6]'">
                                        <template v-if="plan.popular">
                                            <div class="absolute -top-3.5 left-1/2 -translate-x-1/2">
                                            ...
                                            <div>
                                                ...
                                                <ul class="space-y-1.5">
                                                    <li v-for="(doc, di) in plan.dokumen" :key="`doc-${di}`"
                                                        ...
                                                        <span
                                                            class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                            :class="expandedDocs[`extra-${pi}-${di}`] ? '' : 'truncate'"
                                                            @click="toggleDoc(`extra-${pi}-${di}`)">{{ doc.label
                                                            }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div>
                                                ...
                                                <ul class="space-y-1.5">
                                                    <li v-for="(item, ti) in plan.termasuk" :key="`termasuk-${ti}`"
                                                        ...
                                                        <span
                                                            class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                            :class="expandedDocs[`extra-termasuk-${pi}-${ti}`] ? '' : 'truncate'"
                                                            @click="toggleDoc(`extra-termasuk-${pi}-${ti}`)">{{
                                                            item.label }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div>
                                                ...
                                                <ul class="space-y-1.5">
                                                    <li v-for="(bon, bi) in plan.bonus" :key="`bonus-${bi}`"
                                                        ...
                                                        <span
                                                            class="text-[11px] leading-[1.5] text-[#3D3D3A] cursor-pointer"
                                                            :class="expandedDocs[`extra-bonus-${pi}-${bi}`] ? '' : 'truncate'"
                                                            @click="toggleDoc(`extra-bonus-${pi}-${bi}`)">{{ bon.label
                                                            }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <template v-else>
                                ...
                                <div class="grid grid-cols-1 gap-4"
                                    :class="currentPlans.slice(3).length === 1 ? 'sm:grid-cols-1 sm:w-1/3 sm:mx-auto' : 'sm:grid-cols-2'">
                                    <div v-for="(plan, pi) in currentPlans.slice(3)" :key="`plan-extra-${pi}`"
                                        class="relative flex flex-col rounded-xl border"
                                        :class="plan.popular ? 'border-primary shadow-md shadow-primary/10' : 'border-[#E8E8E6]'">
                                        <template v-if="plan.popular">
                            ...
                            <!-- Alert Info -->
                            <div v-if="localizedProduct.plans_alert.length" class="mt-4 space-y-2">
                                <div v-for="(alert, ai) in localizedProduct.plans_alert" :key="`alert-${ai}`"
                                    class="flex items-center gap-2.5 rounded-2xl bg-[#D6F0FA] px-4 py-3.5">
                                    <svg class="h-4 w-4 text-[#5BB8D4] flex-shrink-0" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="1.8">
                                        <circle cx="12" cy="12" r="10" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01" />
                                    </svg>
                                    <span class="text-[13px] text-[#5BB8D4]">{{ alert }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="currentDasarHukum.length"
                            ...
                            <button @click="dasarHukumOpen = !dasarHukumOpen"
                                ...
                                <div class="flex items-center gap-3">
                                    <img src="/icons/ic-menu-arrow.svg" class="w-6 h-6" alt="" />
                                    <h2 class="text-[15px] font-bold uppercase tracking-widest text-black">
                                        {{ t('services.badanUsahaDetail.sections.dasar_hukum') }}
                                    </h2>
                                </div>
                                <svg class="h-5 w-5 text-[#686964] flex-shrink-0 transition-transform duration-200"
                            ...
                            <div class="relative mb-4">
                                <div class="inline-block w-full rounded-xl border border-white/60 px-4 py-2.5">
                                    <span class="text-[14px] font-extrabold uppercase tracking-widest text-white">
                                        {{ t('services.badanUsahaDetail.sidebar.vip_title') }}
                                    </span>
                                </div>
                            </div>
                            <p class="relative text-[14px] leading-[1.6] text-white/90 mb-5">
                                {{ t('services.badanUsahaDetail.sidebar.vip_desc') }}
                            </p>
<a
                            :href="buildWhatsappLink(localizedProduct.name)"
                            target="_blank" rel="noopener noreferrer"
                            class="relative flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#25D366] py-3
                            text-[13px]
                            font-bold text-white hover:bg-[#20BD5A] transition-colors shadow-lg shadow-black/20"
                            >
                            <img src="/icons/ft-wa.svg" class="mt-0.5 h-5 w-5 flex-shrink-0" alt="wa" />
                            {{ t('services.badanUsahaDetail.sidebar.vip_cta') }}
                            </a>
                            <div class="relative mt-3 text-[11px] text-white/60">
                                {{ t('services.badanUsahaDetail.sidebar.vip_note') }}
                            </div>
                        </div>
                        ...
                        <div class="rounded-2xl border border-[#E8E8E6] bg-white p-5">
                            <div
                                ...
                                <span class="text-[13px] text-[#1A1B18]">{{ localizedProduct.name }}</span>
                            ...
                            <div class="text-[12px] text-[#686964] mb-1">
                                {{ t('services.badanUsahaDetail.sidebar.price_label') }}
                            </div>
                            ...
                            <div class="text-[11px] text-[#686964] mb-4">
                                {{ t('services.badanUsahaDetail.sidebar.price_note') }}
                            </div>
<a
                            :href="buildWhatsappLink(localizedProduct.name)"
                            target="_blank" rel="noopener noreferrer"
                            class="flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] py-2.5
                            text-[13px] font-semibold
                            text-white hover:bg-[#20BD5A] transition-colors"
                            >
                            <img src="/icons/ft-wa.svg" class="mt-0.5 h-6 w-6 flex-shrink-0" alt="wa" />
                            {{ t('services.badanUsahaDetail.sidebar.konsultasi_cta') }}
                            </a>
                            <ul class="mt-4 space-y-2">
                                <li v-for="(feat, fi) in sidebarFeatures" :key="`feat-${fi}`"
                    ...
                    <a
                                ...
                                class="group flex flex-col gap-2 rounded-xl border border-[#E8E8E6] bg-white p-4
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <div class="text-[11px] text-[#686964] mb-0.5">
                                                {{ t('services.badanUsahaDetail.sidebar.related_from') }}
                                            </div>
                                        ...
                                        <span
                                            ...
                                            {{ related.plans ? related.plans.length : 0 }} {{
                                                t('services.badanUsahaDetail.sidebar.related_packages') }}
                                        </span>
                                    </div>
                                    <div
                                        ...
                                        {{ t('services.badanUsahaDetail.sidebar.related_cta') }}
                                        <svg class="h-4 w-4 group-hover:translate-x-0.5 transition-transform" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                                        </svg>
                                    </div>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-[#9e1f16] px-6 py-12 sm:px-10 sm:py-14">
                    ...
                    <div class="relative flex flex-col items-center text-center">
                        <h3
                            ...
                            {{ t('services.badanUsahaDetail.footer.title') }}
                        </h3>
                        <p
                            class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]">
                            {{ t('services.badanUsahaDetail.footer.desc') }}
                        </p>
<a
                        :href="buildWhatsappLink(t('services.badanUsahaDetail.footer.wa_subject'))"
                        target="_blank" rel="noopener noreferrer"
                        class="mt-8 inline-flex items-center gap-2.5 rounded-lg bg-[#25D366] px-6 py-3 text-[14px]
                        font-semibold
                        text-white shadow-lg shadow-[#25D366]/30 transition-all duration-200 hover:-translate-y-0.5
                        hover:bg-[#20BD5A] hover:shadow-xl hover:shadow-[#25D366]/40 sm:px-8 sm:py-3.5 sm:text-[15px]"
                        >
                        {{ t('services.badanUsahaDetail.footer.cta') }}
