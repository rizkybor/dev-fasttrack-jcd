...
const itemMeta = [
    { icon: "/icons/ft-persons-w.svg", path: "/izin-tinggal-tetap" },
    { icon: "/icons/ft-persons-w.svg", path: "/izin-tinggal-tetap" },
    { icon: "/icons/ft-persons-w.svg", path: "/izin-tinggal-tetap" },
    { icon: "/icons/ft-persons-w.svg", path: "/izin-tinggal-tetap" },
];
...
const serviceList = computed(() =>
    tm("services.izinTinggalTetap.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.izinTinggalTetap.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-izin-tinggal-tetap/ft-hero-izin-tinggal-tetap.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.izinTinggalTetap.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.izinTinggalTetap.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.izinTinggalTetap.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.izinTinggalTetap.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.izinTinggalTetap.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.izinTinggalTetap.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/izin-tinggal-tetap/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.izinTinggalTetap.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.izinTinggalTetap.items.cta") }}
                                <svg
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.izinTinggalTetap.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.izinTinggalTetap.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.izinTinggalTetap.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.izinTinggalTetap.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
