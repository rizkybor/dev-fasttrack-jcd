<!-- PAGE INI SEDANG TIDAK DIGUNAKAN KARENA PRODUCT PARENT HANYA 1, KETIKA LEBIH DARI 1 BARU DIGUNAKAN INDEX INI  -->
<script setup>
...
const itemMeta = [
    { icon: "/icons/ft-docs.svg", path: "/penyusunan-peninjauan" },
];

// Merge data locale (title, desc, price, packages) + meta (icon, path)
const serviceList = computed(() =>
    tm("services.penyusunanDanPeninjauanPerjanjian.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const greeting = `${t("services.penyusunanDanPeninjauanPerjanjian.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-penyusunan-dan-peninjauan.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.penyusunanDanPeninjauanPerjanjian.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.penyusunanDanPeninjauanPerjanjian.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.penyusunanDanPeninjauanPerjanjian.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.penyusunanDanPeninjauanPerjanjian.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                    ...
                    >
                        ...
                        {{ t("services.penyusunanDanPeninjauanPerjanjian.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.penyusunanDanPeninjauanPerjanjian.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/penyusunan-peninjauan/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.penyusunanDanPeninjauanPerjanjian.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.penyusunanDanPeninjauanPerjanjian.items.cta") }}
                                <svg
                    ...
                    <FooterCTA
                        :title="t('services.penyusunanDanPeninjauanPerjanjian.cta.title')"
                        :description="t('services.penyusunanDanPeninjauanPerjanjian.cta.desc')"
                        :button-text="t('services.penyusunanDanPeninjauanPerjanjian.cta.whatsapp')"
                        :whatsapp-link="buildWhatsappLink(t('services.penyusunanDanPeninjauanPerjanjian.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
