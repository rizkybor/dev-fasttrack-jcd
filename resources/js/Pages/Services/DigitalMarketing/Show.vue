...
<template>
    <MainLayout>
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t(
                                    "services.digitalMarketingDetail.breadcrumb.current",
                                )
                            }}
                        </a>
                        <svg
                        ...
                        >
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                >
                                    {{
                                        t(
                                            "services.digitalMarketingDetail.sections.penjelasan",
                                        )
                                    }}
                                </h2>
                            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.digitalMarketingDetail.plans.pesan",
                                            )
                                        }}
                                        <svg
                                            class="h-3.5 w-3.5"
                        ...
                        >
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                >
                                    {{
                                        t(
                                            "services.digitalMarketingDetail.sections.dasar_hukum",
                                        )
                                    }}
                                </h2>
                            </div>
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.digitalMarketingDetail.sidebar.related_cta",
                                            )
                                        }}
                                        <svg
        ...
        <FooterCTA
            title="Butuh Konsultasi Soal Digital Marketing?"
            description="Tim Fasttrack siap membantu memilih strategi digital marketing yang<br class='hidden sm:block' /> tepat dan mendampingi seluruh prosesnya."
