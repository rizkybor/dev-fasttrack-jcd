...
const serviceList = computed(() =>
    tm("services.digitalMarketing.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.digitalMarketing.cta.waMessage")} ${productName}.`;
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.digitalMarketing.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.digitalMarketing.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.digitalMarketing.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.digitalMarketing.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.digitalMarketing.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.digitalMarketing.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/digital-marketing/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.digitalMarketing.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.digitalMarketing.items.cta") }}
                                <svg
                    ...
                    <FooterCTA
                        bare
                        :title="t('services.digitalMarketing.cta.title')"
                        :description="t('services.digitalMarketing.cta.desc')"
                        :button-text="t('services.digitalMarketing.cta.whatsapp')"
                        :whatsapp-link="buildWhatsappLink(t('services.digitalMarketing.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
