...
<template>
    <MainLayout>
                ...
                <div class="grid gap-8 lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_320px] min-w-0">
                    ...
                    <div class="flex flex-col gap-5 min-w-0">
                        ...
                        <template v-for="section in localizedProduct.sections" :key="section.id">
                            ...
                            <!-- Type: numbered_accordion (tahapan dengan accordion) -->
                            ...
                            <!-- Type: numbered_list (prosedur / list biasa dengan nomor) -->
                            ...
                            <!-- Type: numbered_bold (Bentuk-bentuk: nomor + bold title + desc) -->
                            ...
                            <!-- Type: grid_check (Aspek Penting: grid 2 col tanpa border card) -->
                        ...
                        <div class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-4 px-5 py-5">
                                    <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-white">
        ...
        <FooterCTA
            :title="t('services.restrukturisasiPerseroanTerbatasDetail.footer.title')"
            :description="t('services.restrukturisasiPerseroanTerbatasDetail.footer.desc')"
            :button-text="t('services.restrukturisasiPerseroanTerbatasDetail.footer.cta')"
