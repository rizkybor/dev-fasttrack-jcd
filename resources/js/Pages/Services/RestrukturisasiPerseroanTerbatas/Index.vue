                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/restrukturisasi-perseroan-terbatas/${productSlugs['restrukturisasi-perseroan-terbatas'][item.id]}`"
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.restrukturisasiPerseroanTerbatas.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
