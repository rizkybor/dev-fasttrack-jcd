...
const itemMeta = [
    { icon: "/icons/ft-persons-w.svg", path: "/legalisasi-kedutaan" },
    { icon: "/icons/ft-persons-w.svg", path: "/legalisasi-kedutaan" },
    { icon: "/icons/ft-persons-w.svg", path: "/legalisasi-kedutaan" },
    { icon: "/icons/ft-persons-w.svg", path: "/legalisasi-kedutaan" },
];
...
const serviceList = computed(() =>
    tm("services.legalisasiKedutaan.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.legalisasiKedutaan.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-legalisasi-kedutaan/ft-hero-legalisasi-kedutaan.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.legalisasiKedutaan.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.legalisasiKedutaan.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.legalisasiKedutaan.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.legalisasiKedutaan.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.legalisasiKedutaan.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.legalisasiKedutaan.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/legalisasi-kedutaan/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.legalisasiKedutaan.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.legalisasiKedutaan.items.cta") }}
                                <svg
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.legalisasiKedutaan.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.legalisasiKedutaan.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.legalisasiKedutaan.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.legalisasiKedutaan.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
