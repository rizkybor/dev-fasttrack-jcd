...
const DEFAULT_PATH = "/perizinan-lainnya";

const serviceList = computed(() => {
    const list = tm("services.perizinanLainnya.list");
...
const buildWhatsappLink = (productName) => {
    const greeting = `${t("services.perizinanLainnya.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-perizinan-lainnya.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.perizinanLainnya.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.perizinanLainnya.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.perizinanLainnya.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.perizinanLainnya.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.perizinanLainnya.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.perizinanLainnya.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/perizinan-lainnya/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.perizinanLainnya.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.perizinanLainnya.items.cta") }}
                                <svg
                    ...
                    <FooterCTA
                        :title="t('services.perizinanLainnya.cta.title')"
                        :description="t('services.perizinanLainnya.cta.desc')"
                        :button-text="t('services.perizinanLainnya.cta.whatsapp')"
                        :whatsapp-link="buildWhatsappLink(t('services.perizinanLainnya.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
