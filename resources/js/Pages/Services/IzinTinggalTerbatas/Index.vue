    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-izin-tinggal-terbatas.png"
                    alt="Hero background"
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/izin-tinggal-terbatas/${productSlugs['izin-tinggal-terbatas'][item.id]}`"
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.izinTinggalTerbatas.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
