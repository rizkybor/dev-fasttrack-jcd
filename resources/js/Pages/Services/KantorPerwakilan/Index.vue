...
const serviceList = computed(() =>
    tm("services.kantorPerwakilan.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const greeting = `${t("services.kantorPerwakilan.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-kantor-perwakilan.png"
                    alt="Hero background"
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/kantor-perwakilan/${item.id}`"
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.kantorPerwakilan.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
