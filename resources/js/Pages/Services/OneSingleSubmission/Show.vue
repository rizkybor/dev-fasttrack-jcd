...
const localizePaket = (p) => {
    ...
    if (p.penjelasan_layanan_items) {
        result.penjelasan_layanan_items =
            pick(p.penjelasan_layanan_items) ?? [];
    }
    ...
    if (p.dokumen_legalitas) {
        ...
        if (p.dokumen_legalitas.dokumen_sub) {
            result.dokumen_legalitas.dokumen_sub =
                pick(p.dokumen_legalitas.dokumen_sub) ?? [];
        }
    }
            ...
            dokumen_legalitas: item.dokumen_legalitas
                ? {
                      ...
                      ...(item.dokumen_legalitas.dokumen_sub
                          ? {
                                dokumen_sub:
                                    pick(item.dokumen_legalitas.dokumen_sub) ??
                                    [],
                            }
                          : {}),
                  }
...
const selectedPaket = computed(
    () =>
        localizedProduct.value?.paket?.find(
            (p) => p.id === selectedPaketId.value,
        ) ??
...
const pilihPaketHeading = computed(() => {
    const data = {
        ...
        zh: isPendaftaranNib.value ? "选择NIB注册套餐" : "选择NIB变更/更新套餐",
    };
...
const dokumenSectionLabel = computed(() => {
    const data = {
        ...
        zh: isPendaftaranNib.value ? "文件" : "经营者可进行以下业务数据变更：",
    };
    return data[locale.value] ?? data.id;
});
</script>
        ...
        <section id="edukasi" class="bg-[#F7F7F5] py-12 sm:py-16">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div
                        class="space-y-4 text-[14px] leading-[1.8] text-[#3D3D3A] text-justify"
                    >
                        ...
                        <template v-if="localizedProduct.penjelasan_umum[1]">
                            ...
                            <ul
                                v-if="
                                    localizedProduct.penjelasan_umum_bullets
                                        ?.length
                                "
                            ...
                            >
                                <li
                                    v-for="(
                                        b, i
                                    ) in localizedProduct.penjelasan_umum_bullets"
                                    :key="`b1-${i}`"
                                >
                                    {{ b }}
                                </li>
                        ...
                        <template v-if="localizedProduct.penjelasan_umum[2]">
                            ...
                            <ul
                                v-if="
                                    localizedProduct.penjelasan_umum_bullets_2
                                        ?.length
                                "
                                class="list-disc list-inside space-y-1 pl-1"
                            >
                                <li
                                    v-for="(
                                        b, i
                                    ) in localizedProduct.penjelasan_umum_bullets_2"
                                    :key="`b2-${i}`"
                                >
                                    {{ b }}
                                </li>
                ...
                >
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <button
                            v-for="paket in localizedProduct.paket"
                            :key="paket.id"
                            @click="selectedPaketId = paket.id"
                        ...
                        >
                            ...
                            <p
                                class="text-[11px] leading-[1.5] mb-4"
                                :class="
                                    selectedPaketId === paket.id
                                        ? 'text-white/80'
                                        : 'text-[#686964]'
                ...
                >
                    ...
                    <div class="flex flex-col gap-6 min-w-0">
                        ...
                        <template v-if="selectedPaket">
                            ...
                            >
                                <div class="flex items-center gap-3 mb-5">
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.oneSingleSubmissionDetail.sections.penjelasan_layanan",
                                            )
                                        }}
                                    </h2>
                                </div>
                                ...
                                <template v-if="selectedPaket.id !== '4'">
                                    <div class="space-y-4">
                                        <p
                                            v-for="(
                                                p, i
                                            ) in selectedPaket.penjelasan_layanan"
                                            :key="`pl-${i}`"
                                ...
                                <template v-else>
                                    ...
                                    >
                                        <li
                                            v-for="(
                                                item, i
                                            ) in selectedPaket.penjelasan_layanan_items"
                                            :key="`pl-item-${i}`"
                                            class="flex gap-4"
                                        >
                                            <span
                            ...
                            <div
                                v-if="selectedPaket.dokumen_legalitas"
                                class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                            >
                                <div class="flex items-center gap-3 mb-5">
                                    <img
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.oneSingleSubmissionDetail.sections.legalitas_didapatkan",
                                            )
                                        }}
                                    </h2>
                                </div>
                                ...
                                >
                                    ...
                                    <ul class="space-y-2.5">
                                        <li
                                            v-for="(item, i) in selectedPaket
                                                .dokumen_legalitas.dokumen"
                                            :key="`dok-${i}`"
                            ...
                            <div v-if="selectedPaket">
                                ...
                                >
                                    <div class="flex items-center gap-3 mb-5">
                                        ...
                                        >
                                            {{
                                                t(
                                                    "services.oneSingleSubmissionDetail.sections.paket_layanan",
                                                )
                                            }}
                                        </h2>
                                    </div>
                                    ...
                                    >
                                        <div
                                            v-for="(
                                                item, idx
                                            ) in selectedPaket.paket_layanan"
                                            :key="`paket-card-${idx}`"
                                        ...
                                        >
                                            ...
                                            <p
                                                class="text-[24px] font-bold text-primary leading-tight mb-5"
                                            >
                                                {{ item.harga }}
                                            </p>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <span
                                                                class="flex-shrink-0 mt-[7px] h-1 w-1 rounded-full bg-[#3D3D3A] inline-block"
                                                            ></span>
                                                            <span>{{
                                                                point
                                                            }}</span>
                                ...
                                <div
                                    v-else-if="selectedPaket.biaya_layanan"
                                    class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                                >
                                    <div class="flex items-center gap-3 mb-5">
                                        <img
                                        ...
                                        >
                                            {{
                                                t(
                                                    "services.oneSingleSubmissionDetail.sections.biaya_layanan",
                                                )
                                            }}
                                        </h2>
                                    </div>
                                    ...
                                    <div
                                        class="flex flex-col sm:flex-row sm:flex-nowrap items-stretch sm:items-center justify-between gap-3 sm:gap-4 rounded-xl px-4 py-4 sm:px-5 sm:py-5"
                                        style="
                            ...
                            <!-- 6. Dasar Hukum -->
                            <div
                                v-if="selectedPaket.dasar_hukum?.length"
                                class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                            >
                                <div class="flex items-center gap-3 mb-5">
                                    <img
                    ...
                    <!-- ===== KANAN: Sidebar ===== -->
                    <div
                        class="flex flex-col gap-4 min-w-0 lg:sticky lg:top-32 lg:self-start"
                    >
                        ...
                        <!-- Paket NIB Lainnya -->
                        <div
                            v-if="localizedProduct.paket?.length > 1"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-5"
                        >
                            <h3
                            ...
                            <div class="flex flex-col gap-2">
                                <button
                                    v-for="paket in localizedProduct.paket.filter(
                                ...
                                >
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p
                                                class="text-[12px] font-bold text-primary"
                                            >
                                                {{ paket.harga }}
                                            </p>
                                        </div>
                                    ...
                                    <svg
                                        class="h-4 w-4 text-[#686964] group-hover:text-primary transition-colors"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        stroke-width="2.5"
