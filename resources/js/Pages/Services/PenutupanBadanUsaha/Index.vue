...
const buildWhatsappLink = (productName) => {
    const greeting = `${t("services.penutupanBadanUsaha.cta.waMessage")} ${productName}.`;
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex flex-col gap-8">
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.penutupanBadanUsaha.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
