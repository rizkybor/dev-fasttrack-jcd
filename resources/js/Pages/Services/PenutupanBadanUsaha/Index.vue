...
const itemMeta = [
    { icon: "/icons/ft-persons-w.svg", path: "/penutupan-badan-usaha" },
    { icon: "/icons/ft-persons-w.svg", path: "/penutupan-badan-usaha" },
    { icon: "/icons/ft-persons-w.svg", path: "/penutupan-badan-usaha" },
    { icon: "/icons/ft-persons-w.svg", path: "/penutupan-badan-usaha" },
];
...
const DEFAULT_PATH = "/penutupan-badan-usaha";

const serviceList = computed(() => {
    const list = tm("services.penutupanBadanUsaha.list");
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.penutupanBadanUsaha.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-penutupan-badan-usaha.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.penutupanBadanUsaha.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.penutupanBadanUsaha.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.penutupanBadanUsaha.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.penutupanBadanUsaha.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.penutupanBadanUsaha.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.penutupanBadanUsaha.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/penutupan-badan-usaha/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.penutupanBadanUsaha.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.penutupanBadanUsaha.items.cta") }}
                                <svg
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.penutupanBadanUsaha.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.penutupanBadanUsaha.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.penutupanBadanUsaha.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.penutupanBadanUsaha.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
