...
const itemMeta = [
    { icon: "/icons/ft-persons-w.svg", path: "/badan-hukum-luar-negeri" },
    { icon: "/icons/ft-persons-w.svg", path: "/badan-hukum-luar-negeri" },
    { icon: "/icons/ft-persons-w.svg", path: "/badan-hukum-luar-negeri" },
    { icon: "/icons/ft-persons-w.svg", path: "/badan-hukum-luar-negeri" },
];
...
const serviceList = computed(() =>
    tm("services.badanHukumLuarNegeri.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.badanHukumLuarNegeri.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-badan-hukum-luar-negeri/ft-hero-badan-hukum-luar-negeri.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.badanHukumLuarNegeri.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.badanHukumLuarNegeri.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.badanHukumLuarNegeri.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.badanHukumLuarNegeri.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.badanHukumLuarNegeri.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.badanHukumLuarNegeri.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/badan-hukum-luar-negeri/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.badanHukumLuarNegeri.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.badanHukumLuarNegeri.items.cta") }}
                                <svg
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.badanHukumLuarNegeri.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.badanHukumLuarNegeri.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.badanHukumLuarNegeri.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.badanHukumLuarNegeri.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
