...
const serviceList = computed(() =>
    tm("services.virtualOffice.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.virtualOffice.cta.waMessage")} ${productName}.`;
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.virtualOffice.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.virtualOffice.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.virtualOffice.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.virtualOffice.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.virtualOffice.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.virtualOffice.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section id="layanan" class="py-[52px]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex flex-col gap-8">
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.virtualOffice.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.virtualOffice.items.cta") }}
                                <svg
                    ...
                    <FooterCTA
                        bare
                        :title="t('services.virtualOffice.cta.title')"
                        :description="t('services.virtualOffice.cta.desc')"
                        :button-text="t('services.virtualOffice.cta.whatsapp')"
                        :whatsapp-link="buildWhatsappLink(t('services.virtualOffice.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
