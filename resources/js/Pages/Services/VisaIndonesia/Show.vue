...
const currentItem = computed(
    () => localizedProduct.value.index_list[activeIndex.value],
);
            ...
            >
                ...
                <div>
                    ...
                    >
                        ...
                        {{ t("services.visaIndonesiaDetail.back") }}
                    </a>
                </div>
            </div>
        </section>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        >
                            {{
                                t(
                                    "services.visaIndonesiaDetail.sections.penjelasan",
                                )
                            }}
                        </h2>
                    </div>
                ...
                >
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        >
                            {{
                                t(
                                    "services.visaIndonesiaDetail.sections.index_visa",
                                )
                            }}
                        </h2>
                    </div>
                    ...
                    >
                        <button
                            v-for="(item, i) in localizedProduct.index_list"
                            :key="`idx-${i}`"
                            @click="activeIndex = i"
                        ...
                        >
                            ...
                            <!-- Excerpt -->
                            <p
                                class="text-[12px] leading-[1.6] mb-4 flex-1"
                                :class="
                                    activeIndex === i
                                        ? 'text-white/85'
                                        : 'text-[#686964]'
                            ...
                            >
                                {{
                                    t(
                                        "services.visaIndonesiaDetail.plans.mulai_dari",
                                    )
                                }}
                            </p>
                            <p
                ...
                >
                    ...
                    <div class="flex flex-col gap-5 min-w-0">
                        ...
                        <div
                            v-if="currentItem?.penjelasan_layanan?.length"
                        ...
                        >
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                >
                                    {{
                                        t(
                                            "services.visaIndonesiaDetail.sections.penjelasan_layanan",
                                        )
                                    }}
                                </h2>
                            </div>
                            <div class="space-y-4">
                                <p
                                    v-for="(
                                        p, i
                                    ) in currentItem.penjelasan_layanan"
                                    :key="`pl-${i}`"
                                    class="text-[14px] leading-[1.8] text-[#3D3D3A] text-justify"
                                >
                                    {{ p }}
                        ...
                        <div
                            v-if="currentItem?.dokumen_diperlukan?.length"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                        >
                            <div class="flex items-center gap-3 mb-5">
                                <img
                                ...
                                >
                                    {{
                                        t(
                                            "services.visaIndonesiaDetail.sections.dokumen_didapat",
                                        )
                                    }}
                                </h2>
                            </div>
                            <div class="space-y-5">
                                <div
                                    v-for="(
                                        grp, gi
                                    ) in currentItem.dokumen_diperlukan"
                                    :key="`dg-${gi}`"
                                >
                                    <p
                        ...
                        <div
                            v-if="currentItem?.persyaratan_dokumen?.length"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                        >
                            <div class="flex items-center gap-3 mb-5">
                                <img
                                ...
                                >
                                    {{
                                        t(
                                            "services.visaIndonesiaDetail.sections.persyaratan_dokumen",
                                        )
                                    }}
                                </h2>
                            </div>
                            <div class="space-y-6">
                                <div
                                    v-for="(
                                        group, gi
                                    ) in currentItem.persyaratan_dokumen"
                                    :key="`pg-${gi}`"
                                >
                                    <p
                        ...
                        <!-- 6. Rincian Biaya -->
                        <div
                            v-if="currentItem?.rincian_biaya"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                        >
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.visaIndonesiaDetail.sections.rincian_biaya",
                                            )
                                        }}
                                    </h2>
                                </div>
                            ...
                            >
                                <div class="flex-1">
                                    <p
                                        v-if="
                                            currentItem.rincian_biaya.tabs?.[
                                                activeBiayaTahun
                                            ]?.label_biaya ??
                                    ...
                                    <div
                                        v-for="(item, ri) in currentItem
                                            .rincian_biaya.tabs?.[
                                            activeBiayaTahun
                                        ]?.items ??
                                        currentItem.rincian_biaya.items"
                                        :key="`rb-${ri}`"
                                    ...
                                    >
                                        ...
                                        >
                                        <span
                                            class="text-[14px] font-bold text-black whitespace-nowrap"
                                            >{{ item.amount }}</span
                                        >
                                    </div>
                                    <hr
                                        class="border-t border-dashed border-[#D9DAD8] my-1"
                                    />
                                    <p
                                        v-if="currentItem.rincian_biaya.note"
                                        class="text-[11px] text-[#9A9A97] mt-3"
                                    >
                                ...
                                <div
                                    class="sm:w-[420px] flex-shrink-0 rounded-xl overflow-hidden"
                                    style="
                                ...
                                >
                                    <div
                                        class="flex items-center justify-between h-full px-5 py-4 gap-4"
                                    >
                                        <div>
                                            <div
                                                class="text-[13px] text-white/80 mb-0.5"
                                            >
                                                {{
                                                    currentItem.rincian_biaya
                                                        .tabs?.[
                                                        activeBiayaTahun
                                                    ]?.penanganan_label ??
                                                    t(
                                                        "services.visaIndonesiaDetail.plans.biaya_penanganan",
                                                    )
                                                }}
                                            </div>
                                            <div
                                        ...
                                        >
                                            {{
                                                t(
                                                    "services.visaIndonesiaDetail.plans.pesan",
                                                )
                                            }}
                                            <svg
                                                class="h-3.5 w-3.5"
                        ...
                        <div
                            v-if="currentItem?.dasar_hukum?.length"
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                        >
                            <button
                            ...
                            >
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        {{
                                            t(
                                                "services.visaIndonesiaDetail.sections.dasar_hukum",
                                            )
                                        }}
                                    </h2>
                                </div>
                            ...
                            <ul
                                v-if="openSectionId === 'dasar-hukum'"
                                class="mt-5 space-y-4"
                            >
                                <li
                                    v-for="(
                                        hukum, i
                                    ) in currentItem.dasar_hukum"
                                    :key="`hukum-${i}`"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    ...
                                    >{{
                                        t(
                                            "services.visaIndonesiaDetail.sidebar.free_konsultasi_badge",
                                        )
                                    }}</span
                                >
                            </div>
                            ...
                            >
                                ...
                                {{
                                    t(
                                        "services.visaIndonesiaDetail.sidebar.konsultasi_cta",
                                    )
                                }}
                            </a>
                        </div>
                        ...
                        >
                            <div class="relative mb-4">
                                ...
                                >
                                    <span
                                        ...
                                        >{{
                                            t(
                                                "services.visaIndonesiaDetail.sidebar.vip_title",
                                            )
                                        }}</span
                                    >
                                </div>
                            ...
                            >
                                ...
                                {{
                                    t(
                                        "services.visaIndonesiaDetail.sidebar.vip_cta",
                                    )
                                }}
                            </a>
                            <div
                            ...
                            >
                                {{
                                    t(
                                        "services.visaIndonesiaDetail.sidebar.vip_note",
                                    )
                                }}
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                {{
                                    t(
                                        "services.visaIndonesiaDetail.sidebar.index_lainnya_title",
                                    )
                                }}
                            </h3>
                                ...
                                >
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        >
                                            {{
                                                t(
                                                    "services.visaIndonesiaDetail.sidebar.related_from",
                                                )
                                            }}
                                            {{ related.price_label }}
                                        </p>
