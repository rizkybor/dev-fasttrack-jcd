...
const serviceList = computed(() =>
    tm("services.visaIndonesia.list").map((item) => ({
        ...item,
        icon: itemIcon,
        path: `/visa-indonesia/${productSlugs['visa-indonesia'][item.id]}`,
    })),
);
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-hero/ft-hero-visa-indonesia.png"
                    alt="Hero background"
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/visa-indonesia/${productSlugs['visa-indonesia'][item.id]}`"
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.visaIndonesia.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
