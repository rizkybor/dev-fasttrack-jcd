                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/perpajakan-dan-pembukuan/${productSlugs['perpajakan-dan-pembukuan'][item.id]}`"
                    ...
                    <FooterCTA
                        ...
                        :whatsapp-link="buildWhatsappLink(t('services.perpajakanDanPembukuan.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
