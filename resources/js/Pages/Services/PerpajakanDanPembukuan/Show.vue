...
<template>
    <MainLayout>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div class="flex flex-col gap-5 min-w-0">
                        <!-- 1. Penjelasan Umum -->
                        <div
                            v-if="product.penjelasan_umum?.length"
                        ...
                        >
                            ...
                            <div
                                v-if="section.type === 'grid_check_desc'"
                                class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                            >
                                <div class="flex items-center gap-3 mb-5">
                                    <img
                                ...
                                <p
                                    v-if="section.intro"
                                    class="text-[14px] leading-[1.8] text-[#3D3D3A] mb-5"
                                >
                                    {{ section.intro }}
                                </p>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p
                                                class="text-[13px] font-bold text-[#1A1B18] leading-snug mb-1"
                                            >
                                                {{ item.title }}
                                            </p>
                                            <p
                                                v-if="item.desc"
                                                class="text-[12px] leading-[1.6] text-[#686964]"
                                            >
                                                {{ item.desc }}
                                            </p>
                                        </div>
                            ...
                            <div
                                v-else-if="section.type === 'numbered_detail'"
                                class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                            >
                                <div class="flex items-center gap-3 mb-5">
                                    <img
                                ...
                                <ol class="space-y-4">
                                    <li
                                        v-for="(item, ni) in section.items"
                                        :key="`nd-${ni}`"
                                    >
                                        <p
                                            class="text-[14px] text-[#1A1B18] leading-snug mb-1.5"
                                        >
                                        ...
                                        <p
                                            v-if="item.desc"
                                            class="text-[14px] leading-[1.7] text-[#3D3D3A] mb-2 pl-5"
                                        >
                                            {{ item.desc }}
                                        </p>
                                        <ul
                            ...
                            <div
                                v-else-if="
                                    section.type === 'numbered_accordion'
                                "
                                class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                            >
                                <button
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p
                                                v-if="item.desc"
                                                class="text-[13px] leading-[1.6] text-[#3D3D3A] mb-2"
                                            >
                                                {{ item.desc }}
                                            </p>
                                            <ul
                        ...
                        <div
                            v-if="
                                product.biaya_layanan_cards?.length ||
                                product.biaya_layanan_single
                            "
                            class="rounded-2xl border border-[#E8E8E6] bg-white p-6 sm:p-8"
                        >
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                >
                                    {{
                                        t(
                                            "services.perpajakanDanPembukuanDetail.sections.biaya_layanan",
                                        )
                                    }}
                                </h2>
                            </div>
                            ...
                            <!-- Grid cards (2x2) -->
                            <div
                                v-if="product.biaya_layanan_cards?.length"
                                class="grid grid-cols-1 sm:grid-cols-2 gap-4"
                            >
                                <div
                                    v-for="(
                                        card, ci
                                    ) in product.biaya_layanan_cards"
                                    :key="`card-${ci}`"
                                ...
                                >
                                    ...
                                    <p
                                        class="text-[22px] font-bold text-primary leading-tight mb-2"
                                    >
                                        {{ card.harga }}
                                    </p>
                                    <div
                                        v-if="card.gratis_konsultasi"
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            class="text-[11px] text-[#3D3D3A]"
                                            >{{
                                                t(
                                                    "services.perpajakanDanPembukuanDetail.plans.gratis_konsultasi",
                                                )
                                            }}</span
                                        >
                                    </div>
                                    <div
                                        v-if="card.mendapatkan?.length"
                                        class="mb-4"
                                    >
                                        <p
                                            class="text-[12px] font-bold text-[#1A1B18] mb-2"
                                        >
                                            {{
                                                t(
                                                    "services.perpajakanDanPembukuanDetail.plans.mendapatkan",
                                                )
                                            }}
                                        </p>
                                    ...
                                    <div class="mt-auto pt-2">
                                        <a
                                            :href="buildWhatsappLink(card.nama)"
                                            target="_blank"
                            ...
                            <!-- Single card -->
                            <div
                                v-else-if="product.biaya_layanan_single"
                            ...
                            >
                                ...
                                <div
                                    v-if="
                                        product.biaya_layanan_single.mendapatkan
                                            ?.length
                                    "
                                    class="mb-4"
                                >
                                    ...
                                    <ul class="space-y-2">
                                        <li
                                            v-for="(m, mi) in product
                                                .biaya_layanan_single
                                                .mendapatkan"
                                            :key="`sm-${mi}`"
                                            class="flex items-start gap-2"
                                        >
                                ...
                                <div
                                    v-if="
                                        product.biaya_layanan_single.termasuk
                                            ?.length
                                    "
                                    class="mb-5"
                                >
                                    ...
                                    <ul class="space-y-2">
                                        <li
                                            v-for="(item, ti) in product
                                                .biaya_layanan_single.termasuk"
                                            :key="`st-${ti}`"
                                            class="flex items-start gap-2"
                                        >
                                            <img
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <span
                                    class="text-[12px] text-[#1A1B18] truncate font-medium uppercase"
                                >
                                    {{ product.name }}
                                </span>
                                <svg
                            ...
                            <div
                                class="text-[28px] font-bold leading-none text-primary mb-4"
                            >
                                {{ product.price_label }}
                            </div>
                            <a
                            ...
                            <ul class="space-y-2">
                                ...
                                >
                                    ...
                                    {{
                                        t(
                                            "services.perpajakanDanPembukuanDetail.sidebar.benefit_1",
                                        )
                                    }}
                                </li>
                                <li
                                ...
                                >
                                    ...
                                    {{
                                        t(
                                            "services.perpajakanDanPembukuanDetail.sidebar.benefit_2",
                                        )
                                    }}
                                </li>
                                <li
                                ...
                                >
                                    ...
                                    {{
                                        t(
                                            "services.perpajakanDanPembukuanDetail.sidebar.benefit_3",
                                        )
                                    }}
                                </li>
                                <li
                                ...
                                >
                                    ...
                                    {{
                                        t(
                                            "services.perpajakanDanPembukuanDetail.sidebar.benefit_4",
                                        )
                                    }}
                                </li>
                            </ul>
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                >
                                    <p
                                        class="text-[13px] font-bold text-[#1A1B18] group-hover:text-primary transition-colors leading-snug"
                                    >
                                        {{ pick(related.name) }}
                                    </p>
                                    <p
                                        class="text-[12px] leading-[1.5] text-[#686964] line-clamp-2"
                                    >
                                    ...
                                    >
                                        <div>
                                            ...
                                            <div
                                                class="text-[16px] font-bold text-primary leading-tight"
                                            >
                                                {{ related.price_label }}
                                            </div>
                                        </div>
                                        <span
                                            v-if="related.paket_count"
                                    ...
                                    <div
                                        class="flex items-center justify-center gap-2 rounded-xl border border-primary py-2 text-[13px] font-semibold text-primary group-hover:bg-primary/5 transition-colors"
                                    >
                                        {{
                                            t(
        ...
        <FooterCTA
            ...
            :description="
                t('services.perpajakanDanPembukuanDetail.footer.desc')
            "
