                ...
                <div class="relative overflow-hidden rounded-2xl bg-[#9e1f16] px-6 py-12 sm:px-10 sm:py-14">
                    ...
                    <div class="relative flex flex-col items-center text-center">
                        <h3 class="max-w-2xl text-[22px] font-bold leading-[32px] text-white sm:text-[28px] sm:leading-[38px]">
                            Kelola Keuangan Perusahaan dengan Lebih Baik Bersama Fasttrack
                        </h3>
                        <p class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]">
                            Pembukuan yang rapi dan laporan keuangan yang akurat merupakan investasi penting bagi keberlangsungan dan pertumbuhan perusahaan. Dengan dukungan sistem administrasi keuangan yang baik, perusahaan dapat mengambil keputusan yang lebih tepat, menjaga kepatuhan, dan membangun fondasi bisnis yang lebih kuat.
                        </p>
                        <a :href="buildWhatsappLink(product.name)" target="_blank" rel="noopener noreferrer"
