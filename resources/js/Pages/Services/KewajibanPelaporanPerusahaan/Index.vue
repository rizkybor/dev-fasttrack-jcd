                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {{ t("services.kewajibanPelaporanUsaha.cta.title") }}
                            </h3>
                            <p
                                class="mt-4 max-w-lg text-[14px] leading-[22px] text-white/80 sm:text-[16px] sm:leading-[24px]"
                            >
                                {{ t("services.kewajibanPelaporanUsaha.cta.desc") }}
                            </p>
                            <a
                                :href="
                                    buildWhatsappLink(
                                        t(
                                            'services.kewajibanPelaporanUsaha.hero.breadcrumb.current',
                                        ),
                                    )
                                "
                                target="_blank"
                            ...
                            >
                                {{ t("services.kewajibanPelaporanUsaha.cta.whatsapp") }}
                                <img
                                    src="/icons/ft-wa.svg"
                                    alt="WhatsApp"
                                    class="h-5 w-5"
