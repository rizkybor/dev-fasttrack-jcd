...
const serviceList = computed(() =>
    tm("services.kewajibanPelaporanUsaha.list").map((item, i) => ({
        ...item,
...
const buildWhatsappLink = (productName) => {
    const message = `${t("services.kewajibanPelaporanUsaha.cta.waMessage")} ${productName}.`;
    ...
    <MainLayout>
        ...
        >
            <div class="absolute inset-0">
                <img
                    src="/images/layanan-kewajiban-pelaporan-perusahaan/ft-hero-kewajiban-pelaporan-perusahaan.png"
                    alt="Hero background"
            ...
            >
                ...
                <nav aria-label="Breadcrumb">
                    ...
                    >
                        ...
                        >
                            {{
                                t("services.kewajibanPelaporanUsaha.hero.breadcrumb.layanan")
                            }}
                        </a>
                        <svg
                            class="h-3 w-3 text-[#9e1f16]"
                        ...
                        <span class="text-sm font-medium text-[#9e1f16]">
                            {{
                                t("services.kewajibanPelaporanUsaha.hero.breadcrumb.current")
                            }}
                        </span>
                    </div>
                </nav>
                ...
                <div class="mt-auto pt-8">
                    ...
                    >
                        {{ t("services.kewajibanPelaporanUsaha.hero.title")
                        }}<br class="hidden sm:block" />
                        <span class="text-white/90">{{
                            t("services.kewajibanPelaporanUsaha.hero.titleSub")
                        }}</span>
                    </h1>
                    <p
                        class="mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base sm:leading-7"
                    >
                        {{ t("services.kewajibanPelaporanUsaha.hero.desc") }}
                    </p>
                    <div class="mt-6">
                        <a
                            href="/layanan"
                        ...
                        >
                            ...
                            {{ t("services.kewajibanPelaporanUsaha.hero.back") }}
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    >
                        <a
                            ...
                            :key="idx"
                            :href="`/kewajiban-pelaporan-perusahaan/${item.id}`"
                        ...
                        >
                            ...
                            <div class="flex items-start justify-between gap-2">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    >
                                        {{
                                            t("services.kewajibanPelaporanUsaha.items.from")
                                        }}
                                    </span>
                                    <span
                            ...
                            >
                                {{ t("services.kewajibanPelaporanUsaha.items.cta") }}
                                <svg
                    ...
                    <FooterCTA
                        bare
                        :title="t('services.kewajibanPelaporanUsaha.cta.title')"
                        :description="t('services.kewajibanPelaporanUsaha.cta.desc')"
                        :button-text="t('services.kewajibanPelaporanUsaha.cta.whatsapp')"
                        :whatsapp-link="buildWhatsappLink(t('services.kewajibanPelaporanUsaha.hero.breadcrumb.current'))"
                    />
                </div>
            </div>
        </section>
