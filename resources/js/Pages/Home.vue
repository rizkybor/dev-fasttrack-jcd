...
// // Pakai agent by key
// waLink('Pendirian PT', { agent: 'sales' })
// waLink('Pendirian PT', { agent: 'cs' })

// // Pakai nomor langsung (diluar daftar)
// waLink('Pendirian PT', { phone: '6281111111111' })
...
<template>
    <MainLayout>
        <!-- ===== 1. HERO SECTION ===== -->
        <section class="relative min-h-[520px] lg:min-h-[580px] flex items-center overflow-hidden">
            <!-- ── Slide Images ─────────────────────────────────────────────── -->
            <transition-group name="hero-fade">
                <img v-for="(img, i) in heroImages" v-show="i === activeSlide" :key="img" :src="img" alt="Hero Banner"
            ...
            <!-- ── Content ─────────────────────────────────────────────────── -->
            <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 py-14 lg:py-[52px]">
        ...
        <section class="relative z-20 mb-5">
            <div class="max-w-3xl ml-auto px-0 sm:px-8 -mt-6 sm:-mt-12">
                <div
                    ...
                    <div class="flex items-center gap-4 w-full sm:w-auto justify-center">
                        <div class="text-center">
                            <div class="text-xl lg:text-2xl font-bold text-[#F9F9F9]">
                ...
                <svg class="absolute -bottom-[30px] right-[10%] z-10 hidden sm:block" width="35" height="32"
                    viewBox="0 0 100 32" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
        ...
        <section class="py-8">
            <div class="bg-[#9e1f16]">
                <div
                    ...
                    <div class="inline-flex items-end gap-2">
                        <div class="flex flex-col gap-2 sm:gap-3">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3">
                                <p class="text-[14px] sm:text-[24px] font-semibold leading-tight text-[#F9F9F9]">
                                    {{ t("home.vip.subtitle") }}
                                </p>
                                <p
                    ...
                    <svg class="hidden lg:block flex-shrink-0" width="250" height="200" viewBox="0 0 90 100" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M40 0L0 50L40 100" stroke="#F9F9F9" stroke-width="20" stroke-linecap="butt"
                    ...
                    <a href="/konsultasi"
                        ...
                        <span class="text-[15px] sm:text-[16px] font-semibold leading-[24px] text-[#F9F9F9]">
                            {{ t("home.vip.cta") }}
                        </span>
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-[#F9F9F9]" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <section id="layanan" class="py-[52px]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex flex-col gap-8">
                    <div class="flex items-center justify-between border-b border-[#D9DAD8] pb-4">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2 flex-grow px-3 py-3">
                                <svg class="h-5 w-5 text-[#42443D] flex-shrink-0" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                </svg>
                                <input v-model="serviceSearch" type="text" :placeholder="t('home.services.search')"
                                    class="w-full border-none bg-transparent p-0 text-[14px] text-[#42443D] placeholder-[#42443D] focus:ring-0 focus:outline-none" />
                            </div>
                        </div>
                    </div>

                    <div v-for="(category, catIdx) in filteredCategories" :key="catIdx" class="flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="/icons/ft-docs.svg" class="w-6 h-6" alt="" />
                                <h3 class="text-[18px] font-bold leading-[27px] text-[#1A1B18]">
                                    {{ category.title }}
                                </h3>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <a v-for="(item, itemIdx) in category.items" :key="itemIdx" :href="item.path"
                                ...
                                <div class="flex flex-col gap-4 flex-grow">
                                    ...
                                    <img :src="item.icon" class="w-10 h-10 md:w-14 md:h-14" alt="" />

                                    <div class="flex flex-col gap-1">
                                        <h4 class="text-[16px] font-bold leading-[24px] text-[#1A1B18]">
                                            {{ item.title }}
                                        </h4>
                                        <p class="text-[14px] leading-[21px] text-[#282925] min-h-[63px]">
                                            {{ item.description }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="relative my-4">
                                    <div class="h-px w-full bg-[#686964] opacity-30"></div>
                                </div>
...
<section class="bg-[#42443D] pt-[52px] pb-[120px]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
                <div class="flex flex-col gap-12">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        <!-- Image -->
                        <div>
                            <img src="/images/ft-img-tentang-kami.png" alt="Tim FastTrack di kantor"
                                class="w-full h-[300px] md:h-[386px] rounded-2xl object-cover" loading="lazy" />
                        </div>
                        ...
                        <div class="flex flex-col justify-center">
                            <div class="flex flex-col gap-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <h2 class="text-[28px] font-bold leading-[36px] text-[#1A1B18]">
                                        {{ t("home.about.title") }}
                                    </h2>
                                </div>

                                <div class="space-y-3">
                                    <p class="text-[14px] leading-[22px] text-[#4A4B47] text-justify">
                                        {{ t("home.about.desc1") }}
                                    </p>
                                    <p class="text-[14px] leading-[22px] text-[#4A4B47] text-justify">
                                        {{ t("home.about.desc2") }}
                                ...
                                <!-- Stats -->
                                <div class="grid grid-cols-3 divide-x divide-[#D9DAD8] pt-3">
                                    <div class="flex flex-col items-center gap-1 px-2">
                                        <span class="text-[19px] sm:text-[26px] font-bold leading-tight text-primary">{{
                                            t(
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div
                            ...
                            <h3 class="text-[24px] font-bold leading-[36px] text-primary">
                                {{ t("home.about.philosophy.title") }}
                            </h3>
                            <p class="text-[14px] leading-[21px] text-[#1A1B18] justify-center">
        ...
        <section class="py-[52px] bg-[#9e1f16]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
                <div class="flex flex-col items-center gap-8">
                    <div class="flex flex-col items-center gap-2.5 text-center px-4 lg:px-[282px]">
                        <h2 class="text-[28px] font-bold leading-[42px] text-[#F9F9F9]">
                            {{ t("home.why.title") }}
                        </h2>
                        <p class="text-[16px] leading-[24px] text-[#F9F9F9] max-w-[708px]">
                            {{ t("home.why.subtitle") }}
                        </p>
                    </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-col gap-3 rounded-b-xl bg-[#FEFEFE] p-4 backdrop-blur-[13px]">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <p class="text-[14px] leading-[21px] text-[#42443D]">
                    ...
                    <div class="flex flex-col items-start self-stretch gap-6">
                        <div class="flex items-center justify-center gap-2.5 self-stretch">
                            <div class="flex-grow h-px bg-[#D9DAD8]"></div>
                            <span class="text-[24px] font-semibold leading-[36px] text-[#F9F9F9] whitespace-nowrap">{{
                        ...
                        <div
                            ...
                            <div class="flex flex-col items-center flex-grow gap-3 py-8">
                                <svg class="w-12 h-12 text-[#F9F9F9]" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <h3 class="text-[18px] font-semibold leading-[27px] text-[#FEFEFE]">
                                    {{ t("home.why.onTime.title") }}
                                </h3>
                                <p class="text-[14px] leading-[21px] text-[#F9F9F9] text-center max-w-[219px]">
                                    {{ t("home.why.onTime.desc") }}
                                </p>
                            </div>
                            <div class="block sm:hidden w-full h-px bg-[#D9DAD8]"></div>
                            <div class="hidden sm:block w-px self-stretch bg-[#D9DAD8]"></div>
                            <div class="flex flex-col items-center flex-grow gap-3 py-8">
                                <svg class="w-12 h-12 text-[#F9F9F9]" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                ...
                                <p class="text-[14px] leading-[21px] text-[#F9F9F9] text-center max-w-[229px]">
                            ...
                            <div class="flex flex-col items-center flex-grow gap-3 py-8">
                                ...
                                <p class="text-[14px] leading-[21px] text-[#F9F9F9] text-center max-w-[190px]">
                            ...
                            <div class="flex flex-col items-center flex-grow gap-3 py-8">
                                ...
                                <p class="text-[14px] leading-[21px] text-[#F9F9F9] text-center max-w-[210px]">
        ...
        <section class="pt-[52px] pb-0 bg-[#F9F9F9]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
                <div class="flex flex-col items-center gap-8 pb-10">
                    <h2 class="text-[28px] font-bold leading-[42px] text-[#1A1B18] text-center">
                        {{ t("home.tools.title") }}
                    </h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 self-stretch rounded-b-2xl">
                        <component :is="tool.url ? 'a' : 'button'" v-for="tool in tools" :key="tool.title" v-bind="tool.url
                            ? { href: tool.url }
                            : { type: 'button' }
                            "
                            ...
                            <div class="flex flex-col gap-1 flex-1">
                                ...
                                <p class="text-sm leading-relaxed text-[#1A1B18]">
                                    {{ tool.description }}
                                </p>
                            </div>
        ...
        <section class="py-[52px] bg-[#42443D]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
                <div class="flex flex-col items-center gap-8">
                    <h2 class="text-[28px] font-bold leading-[42px] text-[#F9F9F9] text-center">
                    ...
                    <div
                        ...
                        <a v-for="office in virtualOffices" :key="office.name" :href="office.path"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    <svg class="w-[18px] h-[18px] text-[#F9F9F9] flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex flex-col gap-6 border border-[#D9DAD8] rounded-xl bg-[#FEFEFE] p-[23px]">
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="inline-flex items-center gap-1">
                                    <svg class="w-5 h-5 text-[#8E8F8B]" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                    <span class="text-[12px] font-semibold leading-[18px] text-[#8E8F8B]">{{
                    ...
                    <div v-for="row in marqueeRows" :key="row.id" class="marquee-row">
                        ...
                        <div :class="[
                            ...
                            <div class="marquee-set">
                                <div v-for="logo in row.logos" :key="logo.src" class="marquee-card">
                                    <img :src="logo.src" :alt="logo.alt" loading="lazy" />
                                </div>
                            </div>
                            <!-- Set 2 (duplikat untuk seamless loop) -->
                            <div class="marquee-set" aria-hidden="true">
                                <div v-for="logo in row.logos" :key="logo.src + '-dup'" class="marquee-card">
                                    <img :src="logo.src" :alt="logo.alt" loading="lazy" />
                                </div>
                            </div>
                        </div>
        ...
        <section class="bg-[#F9F9F9] pt-10 sm:pt-[52px] pb-0 overflow-hidden">
            <div class="flex flex-col items-center gap-6 sm:gap-8">
                <h2 class="text-[22px] sm:text-[26px] font-bold leading-[42px] text-[#1A1B18]">
                ...
                <div
                    ...
                    ]" :key="i" class="flex items-center justify-center h-[52px] sm:h-[64px] sm:px-9 sm:min-w-[120px]"
                        :class="{ 'sm:border-r sm:border-[#D3D1C7]': i < 5 }">
                        <img :src="afiliasi.src" :alt="afiliasi.alt"
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div
                        ...
                        <form @submit.prevent class="flex flex-col gap-4">
                            <div class="flex flex-col gap-4">
                                ...
                                <div
                                    class="flex items-center h-[44px] rounded-lg bg-white outline outline-1 outline-[#E9EAEB] overflow-hidden">
                                    <input type="tel" :placeholder="t('home.contact.whatsapp')
                                        "
                                        class="flex-1 px-3 py-3 text-[14px] text-[#8E8F8B] bg-transparent outline-none placeholder-[#8E8F8B]"
                                        required />
                                </div>
                                <div
                                    class="flex items-center h-[44px] rounded-lg bg-white outline outline-1 outline-[#E9EAEB] overflow-hidden">
                                    <input type="text" :placeholder="t('home.contact.business')
                                        "
                                        class="flex-1 px-3 py-3 text-[14px] text-[#8E8F8B] bg-transparent outline-none placeholder-[#8E8F8B]" />
                                </div>
                                <div
                                    ...
                                    <textarea rows="5" :placeholder="t('home.contact.message')"
                                        ...
                                        required></textarea>
                                    <svg class="absolute right-3 bottom-3 w-2 h-2 text-[#8E8F8B]" viewBox="0 0 8 8"
                                        fill="currentColor">
                            ...
                            <div
                                ...
                                <div class="ml-auto flex flex-col items-center">
                                    <svg class="w-8 h-8 text-[#4A90D9]" viewBox="0 0 38 38" fill="none">
                                        ...
                                        <path d="M34 19C34 15.5 32.5 12.3 30 10" stroke="#9e1f16" stroke-width="2.5"
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <button type="submit"
                                    ...
                                    <span class="text-[14px] font-semibold leading-[21px] text-[#F9F9F9]">{{
                    ...
                    <div class="flex-1 flex flex-col gap-6">
                        <div
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <a href="tel:02173885036"
                                        class="text-[14px] leading-[21px] text-[#1A1B18] hover:text-[#9e1f16]">0217 3885
                                        036</a>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div
                                    ...
                                    <a href="https://wa.me/6282298604144"
                                        class="text-[14px] leading-[21px] text-[#1A1B18] hover:text-[#9e1f16]">0822 9860
                                        4144</a>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div
                                    ...
                                    <a href="mailto:cs@fasttrack.legal"
                                        class="text-[14px] leading-[21px] text-[#1A1B18] hover:text-[#9e1f16]">cs@fasttrack.legal</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <a href="https://maps.google.com/?q=Fasttrack+Jakarta+HO" target="_blank"
                                ...
                                <span class="text-[14px] leading-[21px]">Open in Maps</span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <GeneratorNamaModal v-model="showGeneratorModal" @check-name="transferToCheckName" />

        <!-- ===== 15. CHECK NAME MODAL ===== -->
        <CekNamaModal v-model="showCheckNameModal" :prefill-name="prefillCheckName"
