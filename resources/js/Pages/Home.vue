            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                >
                    <a
                        ...
                        :key="promo.image"
                        :href="waLink(promo.service, { agent: promo.agent })"
                        target="_blank"
                ...
                <div class="flex flex-col items-center gap-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <img
                                v-for="(img, i) in office.images"
                                :key="img"
                                :src="img"
                                :alt="office.name"
                                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-700"
                                :class="
                                    i === getVoSlide(office.name)
                                        ? 'opacity-100'
                                        : 'opacity-0'
                                "
                            />
                            ...
                            <!-- Dots indicator -->
                            <div
                                class="absolute bottom-[72px] left-1/2 -translate-x-1/2 flex gap-1 z-10"
                            >
                                <span
                                    v-for="(_, i) in office.images"
                                    :key="i"
                            ...
                            <!-- Status badge -->
                            <div
                                class="relative z-10 flex flex-col items-end p-4"
                            >
                                <span
