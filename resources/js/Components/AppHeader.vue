...
const toggleMobileCategory = (index) => {
    mobileActiveCategory.value =
        mobileActiveCategory.value === index ? null : index;
    mobileActiveService.value = null;
};

const toggleMobileService = (index) => {
    mobileActiveService.value =
        mobileActiveService.value === index ? null : index;
};
                ...
                <nav class="px-3 pt-3 pb-5" aria-label="Mobile Navigation">
                    ...
                    >
                        ...
                        <div
                            ...
                            class="border-t border-[#E5E5E0] bg-[#FAFAF8] p-1.5 space-y-0.5"
                        >
                            <!-- Level 1: Title -->
                            <div
                                v-for="(category, cIdx) in serviceCategories"
                                :key="`mobile-cat-${category.title}`"
                            >
                                <button
                                    type="button"
                                    class="flex w-full items-center gap-2 px-3 py-2.5 rounded-lg text-[12.5px] font-bold transition-colors text-left"
                                    :class="
                                        mobileActiveCategory === cIdx
                                ...
                                >
                                    {{ category.title }}
                                    <svg
                                        class="ml-auto h-3.5 w-3.5 transition-transform duration-200 flex-shrink-0"
                                        :class="
                                            mobileActiveCategory === cIdx
                                                ? 'rotate-180 text-[#9e1f16]'
                                                : 'text-[#999]'
                                ...
                                <!-- Level 2: Layanan -->
                                <div
                                    v-if="mobileActiveCategory === cIdx"
                                    class="pl-3 py-0.5 space-y-0.5"
                                >
                                    <div
                                        v-for="(
                                            service, sIdx
                                    ...
                                    >
                                        <div class="flex items-stretch">
                                            ...
                                            <button
                                                ...
                                                :aria-expanded="
                                                    mobileActiveService === sIdx
                                                "
                                                @click="
                                                    toggleMobileService(sIdx)
                                                "
                                            >
                                                <svg
                        ...
                        >
                            <div class="flex items-start gap-2.5">
                                ...
                                >
                                    ...
                                    <svg
                                        v-else-if="category.icon === 'document'"
                                        class="h-5 w-5"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    ...
                                    <svg
                                        v-else-if="category.icon === 'license'"
                                        class="h-5 w-5"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    ...
                                    <svg
                                        v-else-if="category.icon === 'shield'"
                                        class="h-5 w-5"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="mt-1.5 space-y-2">
                                        ...
                                        >
                                            <div
                                                class="-mx-1.5 flex items-center gap-1"
                                            >
                                                <a
                                                    :href="service.path"
