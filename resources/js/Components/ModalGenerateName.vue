            ...
            <transition enter-active-class="transition duration-250 ease-out"
                ...
                <div v-if="modelValue"
                    ...
                    <div class="flex items-start gap-3 px-6 pt-6 pb-5">
                            ...
                            <img src="/icons/ic-tools-gennama.svg" alt="Generator Nama" class="w-10 h-10" />
                    ...
                    <!-- Body -->
                    <div class="px-6 py-5 space-y-3 max-h-[100vh] overflow-y-auto overscroll-contain">
                        <!-- Kata kunci -->
                        <div>
                            <label class="block text-[13px] font-semibold text-[#1A1B18] mb-1.5">
                                Masukkan 1 Kata Kunci
                            </label>
                            <input v-model="keyword" type="text" placeholder="Contoh: Teknologi"
                        ...
                        <div class="relative">
                            <select v-model="selectedBidang"
                                ...
                                :class="selectedBidang
                                        ? 'text-[#1A1B18]'
                                        : 'text-[#AAAAAA]'
                                    ">
                                <option value="" disabled>Bidang Usaha</option>
                                <option v-for="opt in bidangOptions" :key="opt" :value="opt">
                                    {{ opt }}
                                </option>
                            </select>
                            <div class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[#42443D]">
                        ...
                        <button type="button"
                            ...
                            :class="canGenerate && !isLoading
                                ...
                                " :disabled="!canGenerate || isLoading" @click="generate">
                        ...
                        <transition enter-active-class="transition duration-300 ease-out"
                            ...
                            <div v-if="hasGenerated && results.length" class="pt-1">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-[13px] font-semibold text-[#1A1B18]">Hasil Rekomendasi</span>
                                    <button type="button"
                                ...
                                <div
                                    ...
                                    <div v-for="(name, i) in results" :key="name"
                                        ...
                                        <span class="text-[13.5px] font-medium text-[#1A1B18]">{{ name }}</span>
                                        <button type="button"
                        ...
                        <!-- Disclaimer -->
                        <div class="flex gap-2.5 p-3.5 rounded-xl bg-[#EAF4FF] border border-[#B3D4F5]">
                            <svg class="flex-shrink-0 w-4 h-4 text-[#1A73E8] mt-0.5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 16v-4M12 8h.01" />
                            </svg>
                            <p class="text-[12px] text-[#1A73E8] leading-relaxed">
                                ...
                                <button type="button" class="font-semibold underline underline-offset-2"
