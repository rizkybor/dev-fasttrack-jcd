...
<template>
    ...
    <div class="min-h-screen bg-white text-secondary font-sans flex flex-col">
        <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:rounded-full focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-secondary focus:shadow-lg">
            Lewati ke konten
        </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20 items-center">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="/" class="text-3xl font-extrabold text-secondary tracking-tight">
                            FAST<span class="text-primary">TRACK</span>
                        </a>
                    </div>
                    ...
                    <nav class="hidden md:flex space-x-8 items-center">
                        ...
                        <a href="/tentang-kami" class="text-sm font-semibold text-gray-700 hover:text-primary transition uppercase tracking-wide">Tentang Kami</a>
                    ...
                    <div class="hidden md:flex items-center">
                        <a href="/kontak" class="bg-white border-2 border-primary text-primary hover:bg-primary hover:text-white font-bold py-2 px-6 rounded-full transition duration-300 shadow-sm">
                            Konsultasi Gratis
                        </a>
                    </div>
                    ...
                    <div class="md:hidden flex items-center">
                        <button
                            type="button"
                            class="inline-flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 text-gray-600 transition hover:border-primary hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                ...
                >
                    <nav class="space-y-2 px-4 py-4 pb-6" aria-label="Mobile Navigation">
                        ...
                        <div class="rounded-2xl border border-gray-100">
                            <button
                                type="button"
                                class="flex w-full items-center justify-between px-4 py-3 text-sm font-semibold text-gray-700"
                            ...
                            <div v-if="mobileServicesOpen" class="space-y-1 border-t border-gray-100 px-3 py-3">
                                <a
                                    v-for="group in serviceCategories"
                                    :key="`mobile-${group.title}`"
                                    :href="group.path"
                                    class="block rounded-xl px-3 py-2 text-sm text-gray-600 transition hover:bg-primary/5 hover:text-primary"
                                    @click="closeAllMenus"
                                >
                                    {{ group.title }}
                                </a>
                        ...
                        <a href="/tentang-kami" class="block rounded-2xl px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-primary/5 hover:text-primary" @click="closeAllMenus">
                            Tentang Kami
                        </a>
                        ...
                        <div class="rounded-2xl border border-gray-100">
                            <button
                                ...
                                @click="mobileTipsOpen = !mobileTipsOpen"
                            >
                                <span>Tips Bisnis</span>
                                <svg class="h-4 w-4 transition-transform duration-200" :class="mobileTipsOpen ? 'rotate-180 text-primary' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                        ...
                        <a href="/kontak" class="mt-2 block rounded-full bg-primary px-5 py-3 text-center text-sm font-bold text-white transition hover:bg-pink-600" @click="closeAllMenus">
                            Konsultasi Gratis
                        </a>
                    </nav>
                </div>
        ...
        <!-- Footer -->
        <footer class="bg-secondary text-gray-300 py-16 mt-auto">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <!-- Column 1 -->
                    <div>
                        <h4 class="text-white text-lg font-bold mb-6">Tentang Kami</h4>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm">
                            <li><a href="/layanan/pendirian-pt" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Pendirian PT</a></li>
                            <li><a href="/layanan/pendirian-cv" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Pendirian CV</a></li>
                            <li><a href="/layanan/virtual-office" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Virtual Office</a></li>
                            <li><a href="/perizinan" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Perizinan Khusus</a></li>
                            <li><a href="/haki" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Pendaftaran Merek</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm">
                            ...
                            <li><a href="/promo" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Promo</a></li>
                            <li><a href="/kontak" class="hover:text-primary transition flex items-center"><span class="mr-2">&rsaquo;</span> Hubungi Kami</a></li>
                        </ul>
                    </div>
                ...
                <div class="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p class="text-sm text-gray-500 mb-4 md:mb-0">
                        &copy; 2024 FASTTRACK. All Rights Reserved.
                    </p>
                    <div class="flex space-x-4">
                        <a href="https://facebook.com/fasttrack" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-white transition">
                            <span class="sr-only">Facebook</span>
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"/></svg>
                        </a>
                        <a href="https://instagram.com/fasttrack" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-white transition">
                        ...
                        <a href="https://linkedin.com/company/fasttrack" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-white transition">
