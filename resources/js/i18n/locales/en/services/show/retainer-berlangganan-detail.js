export default {
    ...
    sections: {
        ...
        paket_regular: "Regular Packages",
        corporate_secretary: "Corporate Secretary Subscription",
    },
    table: {
        jenis_layanan: "Service Type (per month)",
        skala_terpilih: "Selected scale",
        konsultasi_cta: "Consult via WhatsApp",
    },
    plans: {
        paling_populer: "Most Popular",
        mulai_dari: "Starting from",
        berlangganan: "Subscribe Now",
    },
    sidebar: {
