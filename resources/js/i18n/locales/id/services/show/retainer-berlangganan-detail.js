export default {
    ...
    sections: {
        ...
        paket_regular: "Paket Regular",
        corporate_secretary: "Berlangganan Corporate Secretary",
    },
    table: {
        jenis_layanan: "Jenis Layanan (per bulan)",
        skala_terpilih: "Skala terpilih",
        konsultasi_cta: "Konsultasi via Whatsapp",
    },
    plans: {
        paling_populer: "Paling Populer",
        mulai_dari: "Mulai dari",
        berlangganan: "Berlangganan Sekarang",
    },
    sidebar: {
